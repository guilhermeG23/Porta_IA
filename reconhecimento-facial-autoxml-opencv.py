#Arquivo de terceiro para reconhecimento facial
import cv2, os
...
#Fiz algumas alteracoes por causa que nao encontrava o comando find
#Tive que alterar essa linha e adicionar o arquivo haar no diretorio
xml_path = os.path.join(cv2path, xml_name)
